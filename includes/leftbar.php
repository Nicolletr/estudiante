<div class="left-sidebar box-shadow " style="  background-color: #65BFA6; ">
        ...
        <div class="sidebar-nav">
            <ul class="side-nav color-gray">
                ...
                <li class="has-children">
                    <a href="#"><i class="fa fa-file-text"></i> <span>Gestión de Años Escolares</span></i></a>
                    <ul class="child-nav">
                ...
                <li class="has-children">
                    <a href="#"><i class="fa fa-book"></i> <span>Materias</span></a>
                    <ul class="child-nav">
            ...
            <li class="has-children">
                <a href="#"><i class="fa fa-users"></i> <span>Estudiantes</span></a>
                <ul class="child-nav">
            ...
            <li class="has-children">
                <a href="#"><i class="fa fa-file-o"></i> <span>Resultados</span> </a> <!--<i class="fa fa-angle-right arrow"></i>-->
                <ul class="child-nav">
