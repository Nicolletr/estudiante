...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/resultados/styless.css">
    <!-- Favicon -->
            ...
            <div class="content-container">
                ...
                <div class="main-page">
                    <div class="container-fluid">
                        ...
                        <h2><a href="https://walink.co/c9a23c" target="_blank" ><img style="height: 70px" src="assets/images/footer-logo.png"> </a></h2>
                        <h1 > Resultados de los Estudiante</h1>
                        <!-- /.row -->
                    </div>
                    <!-- /.container-fluid -->
                                            ...
                                            <div class="panel-title">
                                                ...
                                                if ($stmt->rowCount() > 0) {
                                                    foreach ($resultss as $row) {   ?>
                                                        <p class="student-info"><b>Nombre de Estudiante:</b> <?php echo htmlentities($row->StudentName); ?></p>
                                                        <p class="student-info"><b>ID Roll:</b> <?php echo htmlentities($row->RollId); ?>
                                                        <p class="student-info"><b>Año Lectivo:</b> <?php echo htmlentities($row->ClassName); ?>(<?php echo htmlentities($row->Section); ?>)
                                                        <?php }
